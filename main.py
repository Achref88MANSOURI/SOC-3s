...
from schemas import CanonicalAlert, TriageResult
...
async def triage(request: TriageRequest):
    ...
    try:
        ...
        logger.error("Triage failed for alert_id=%s: %s\n%s",
                      alert.alert_id, str(e), traceback.format_exc())
